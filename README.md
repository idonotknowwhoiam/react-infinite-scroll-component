...
| **pullDownToRefreshThresholdY** | number               | minimum distance the user needs to pull down to trigger the refresh, `default=100px` , a lower value may be needed to trigger the refresh depending your users browser.                                                                                                                                                                       |
| **pullDownToRefreshThresholdX** | number               | horizontal safezones, if the value bigger than trashhold the pulldown will stoped, `recommended around 30px`                                                                                                                                                                                                                                  |
| **pullDownSafeZone**            | number               | the pulldown will work only if that safezones trashold is reached, `recommended around 15`                                                                                                                                                                                                                                                    |
